...
let build = gulp.series(clean, cssLib, gulp.parallel(js, cssbuild, html, images));
let dev = gulp.series(clean, cssLib, gulp.parallel(js, cssdev, html, images), watcher);
//let watch = gulp.series(build, watcher);
